...
Simulate a large population ($n=500000$) where each individual has 66 BMI associated SNPs [@Locke2015]  (using only European, LD independent SNPs), PD status, age values, BMI values, and alive/dead status. Data looks like this (first 6 rows):
